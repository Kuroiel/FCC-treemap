...
let colors = ["red", "#b3ecff", "#ffccff", "green", '#86661a', '#62edc9', '#e26f91', '#0f86f3', '#f23785', '#f6f372', '#fe3620', '#c0b4c5', '#07d2c4', '#5ca6aa', '#fc743a', '#d8991f', '#fe3a64', '#a8947b'];
 ...
 let cell =  d3.select("svg")
    ...
    .on("mouseover", function(d, i) {
      d3.select("#tooltip")
        ...
        .html("Console: " + d.data.category + '<br>' + 'Name: ' + d.data.name + '<br>' + 'Value: ' + d.data.value);
    })
...
cell.append("text")
    .selectAll("tspan")
    .data(function (d) { return d.data.name.split(/(\/\ |:\ )/gm)})
    .enter()
    .append("tspan")
    .attr("x", 4)
